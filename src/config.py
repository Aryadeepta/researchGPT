...
- 'input_artifacts': List of artifacts from previous steps that this step consumes (to ensure dense connectivity).
...
- Break every phase into 3-5 small, atomic, testable steps.
- Do NOT create monolithic steps.
- Each step must clearly state what it consumes (input_artifacts) and what it produces (expected_artifacts).

Return ONLY the final JSON array of objects:
[{ "step": "...", "skill": "...", "description": "...", "goal": "...", "expected_artifacts": ["..."], "input_artifacts": ["..."], "implementation_instruction": "..." }, ...]
"""
